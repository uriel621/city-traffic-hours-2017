            ...
            <div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-sm-8 col-md-7 py-4">
                                    ...
                                    <p className="text-muted">My name is Ever and I pretty much felt like doing a simple project using D3. I hope you like it. Thanks</p>
                                </div>
                ...
                <section className="jumbotron text-center">
                    <div className="container">
                        ...
                        <p>
                            <a style={{ "width":"130px", "marginRight":"5px" }} href="https://github.com/uriel621/city-traffic-hours-2017" className="btn btn-info my-2">GitHub Code</a>
                            <a style={{ "width":"130px", "marginLeft":"5px" }} href="http://inrix.com/scorecard/" className="btn btn-primary my-2">City Data</a>
                        </p>
                    </div>
                </section>
            </div>
